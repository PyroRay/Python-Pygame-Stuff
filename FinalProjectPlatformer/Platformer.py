...
platforms = [platform(clrRed, 40, screendim[0], screendim[0]//2, 0, 0, 0, 0, 0), platform(clrRed, 40, 100, 800, 600, screendim[1], 0, screendim[0], 0), platform(clrRed, 40, 100, 500, 600, screendim[1], 0, screendim[0], 0), platform(clrRed, 40, screendim[0], screendim[0]//2, screendim[1], 0, 0, 0, 0)] # creates array of platforms
